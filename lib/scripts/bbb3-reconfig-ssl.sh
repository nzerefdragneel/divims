...
# Retrieve new data
OLD_EXTERNAL_IPV4=104.248.148.57
NEW_EXTERNAL_IPV4=104.248.148.57
EMAIL=nguyentranngocsuong94@gmail.com
OLD_DOMAIN=bbbdemo1.scalelitebbb.systems
NEW_DOMAIN=bbbdemo1.scalelitebbb.systems
...
bbb-conf --restart
#  wget -qO- https://raw.githubusercontent.com/bigbluebutton/bbb-install/v3.0.x-release/bbb-install.sh | bash -s -- -w -v jammy-300  -d -s bbbdemo1.scalelitebbb.systems 

#  152.42.161.112 snapshot
