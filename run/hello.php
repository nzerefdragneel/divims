...
$logger->pushHandler(
    new FilterHandler(
        new DeduplicationHandler(
            new NativeMailerHandler("nguyentranngocsuong94@gmail.com", "Warning : DiViM-S $project", "<mail_from_address>", Logger::WARNING),
...
$logger->pushHandler(
    new DeduplicationHandler(
        new NativeMailerHandler("nguyentranngocsuong94@gmail.com", "Error : DiViM-S $project", "<mail_from_address>", Logger::ERROR),
